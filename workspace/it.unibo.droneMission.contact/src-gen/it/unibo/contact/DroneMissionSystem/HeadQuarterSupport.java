	...
	*/
	...
	protected void st_HeadQuarter_onMission()  throws Exception{
		...
		if(resCheckMsg != null){
			...
			return;}
		//[it.unibo.indigo.contact.impl.SignalImpl@4ae23de5 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@4b4dabcb (name: notify) (var: null)] | photo isSignal=false
