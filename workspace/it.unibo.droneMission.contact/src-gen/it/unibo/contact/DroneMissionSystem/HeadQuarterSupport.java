	...
	*/
	...
	protected void st_HeadQuarter_onMission()  throws Exception{
		...
		if(resCheckMsg != null){
			...
			return;}
		//[it.unibo.indigo.contact.impl.SignalImpl@7c50ecbc (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@24e66a67 (name: notify) (var: null)] | photo isSignal=false
