...
public abstract class DroneSupport extends Subject{
	...
	*/
	...
	protected void st_Drone_onMission()  throws Exception{
		...
		//[it.unibo.indigo.contact.impl.SignalImpl@7c72c382 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@5281cba2 (name: notify) (var: null)] | command isSignal=false
