...
public abstract class DroneSupport extends Subject{
	...
	*/
	...
	protected void st_Drone_onMission()  throws Exception{
		...
		//[it.unibo.indigo.contact.impl.SignalImpl@14468afb (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@234e6f23 (name: notify) (var: null)] | command isSignal=false
