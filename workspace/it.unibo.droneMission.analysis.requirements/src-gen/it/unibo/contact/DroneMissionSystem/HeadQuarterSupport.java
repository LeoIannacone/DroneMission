...
public abstract class HeadQuarterSupport extends Subject{
	...
	* -------------------------------------- 
	*/ 
	protected abstract java.lang.String getCommandStart() throws Exception;
	protected abstract java.lang.String getCommandToSend() throws Exception;
	protected abstract boolean replyIsOk(java.lang.String reply) throws Exception;
	protected abstract void updateDashboard(java.lang.String sensorsDatasReceived) throws Exception;
	protected abstract void storeSensorsData(java.lang.String sensorsDatasReceived) throws Exception;
	protected abstract void storePhotoData(java.lang.String photoReceived) throws Exception;
	protected abstract void showPicturePackage(java.lang.String photoReceived) throws Exception;
	protected abstract boolean missionIsGoingToEnd() throws Exception;
	...
	*/
	...
	public  boolean get_missionEnd(){ return missionEnd; }
	...
	protected void st_HeadQuarter_ready()  throws Exception{
		...
		curAcquireOneReply=hl_headQuarter_demand_command_drone( getCommandStart(  ) );
		...
		tmpCheck =replyIsOk( commandAnswer ) ;
	...
	protected void st_HeadQuarter_onMission()  throws Exception{
		...
		missionEnd =missionIsGoingToEnd(  ) ;
		
		{//XBlockcode
		boolean _missionEnd = missionEnd;
		boolean _operator_equals = BooleanExtensions.operator_equals(_missionEnd, true);
		expXabseResult=_operator_equals;
		}//XBlockcode
		if(  (Boolean)expXabseResult ){ //cond
		...
		//[it.unibo.indigo.contact.impl.SignalImpl@134f3ab6 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@1791ba07 (name: notify) (var: null)] | sensorsData isSignal=true
		resCheckMsg = checkSignal("ANY","sensorsData",false);
		if(resCheckMsg != null){
			curstate = "st_HeadQuarter_receivedSensorsData";
			return;}
		//[it.unibo.indigo.contact.impl.SignalImpl@134f3ab6 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@1791ba07 (name: notify) (var: null)] | photo isSignal=false
	...
	protected void st_HeadQuarter_receivedSensorsData()  throws Exception{
		...
		updateDashboard( sensorsDatasReceived );storeSensorsData( sensorsDatasReceived );curstate = "st_HeadQuarter_onMission"; 
		//resetCurVars(); //leave the current values on
		return;
		/* --- TRANSITION TO NEXT STATE --- */
	}
	protected void st_HeadQuarter_receivedPhoto()  throws Exception{
		...
		storePhotoData(photoReceived);showPicturePackage(photoReceived);curstate = "st_HeadQuarter_onMission"; 
		//resetCurVars(); //leave the current values on
		return;
		/* --- TRANSITION TO NEXT STATE --- */
	}
