...
public abstract class SmartdeviceSupport extends Subject{
	...
	*/ 
	...
	protected abstract boolean isNotifyStart(java.lang.String notify) throws Exception;
	...
	*/
	...
	public  boolean get_tmpNotify(){ return tmpNotify; }
	...
	protected void st_Smartdevice_waitingForData()  throws Exception{
		...
		if(resCheckMsg != null){
			...
			return;}
		//[it.unibo.indigo.contact.impl.SignalImpl@134f3ab6 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@1791ba07 (name: notify) (var: null)] | notify isSignal=true
	...
	protected void st_Smartdevice_notifyHandler()  throws Exception{
		...
		tmpNotify =isNotifyStart( notifyContent ) ;
		
		{//XBlockcode
		boolean _tmpNotify = tmpNotify;
		boolean _operator_equals = BooleanExtensions.operator_equals(_tmpNotify, true);
		...
		{//XBlockcode
		boolean _tmpNotify = tmpNotify;
		boolean _operator_equals = BooleanExtensions.operator_equals(_tmpNotify, false);
		expXabseResult=_operator_equals;
		}//XBlockcode
		if(  (Boolean)expXabseResult ){ //cond
		curstate = "st_Smartdevice_endMission"; 
