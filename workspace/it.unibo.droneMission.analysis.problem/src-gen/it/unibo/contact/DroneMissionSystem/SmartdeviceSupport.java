	...
	*/
	...
	protected void st_Smartdevice_waitingForData()  throws Exception{
		...
		if(resCheckMsg != null){
			...
			return;}
		//[it.unibo.indigo.contact.impl.SignalImpl@30164154 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@51b0a76 (name: notify) (var: null)] | notify isSignal=true
