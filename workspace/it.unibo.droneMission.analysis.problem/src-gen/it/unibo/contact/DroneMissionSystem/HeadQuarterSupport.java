...
public abstract class HeadQuarterSupport extends Subject{
	...
	*/
	...
	protected void st_HeadQuarter_onMission()  throws Exception{
		...
		//[it.unibo.indigo.contact.impl.SignalImpl@30164154 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@51b0a76 (name: notify) (var: null)] | photo isSignal=false
		resCheck = checkForMsg(getName(),"photo",null);
		if(resCheck){
			curstate = "st_HeadQuarter_receivedPhoto";
			return;}
		//[it.unibo.indigo.contact.impl.SignalImpl@30164154 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@51b0a76 (name: notify) (var: null)] | sensorsData isSignal=true
