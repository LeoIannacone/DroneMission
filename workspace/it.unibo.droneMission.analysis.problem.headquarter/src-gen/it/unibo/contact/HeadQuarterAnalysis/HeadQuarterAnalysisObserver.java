...
public  class  HeadQuarterAnalysisObserver extends Subject implements java.util.Observer{
	protected int lastMsgNum = 0; 
    protected String statusStr =  getName() + " | HeadQuarterAnalysisObserver" ;
  
	public HeadQuarterAnalysisObserver( ) throws Exception{
		super();	
		initGui();
	}
	...
	protected void initGui(){
	    env = new EnvFrame( "HeadQuarterAnalysisObserver", this, java.awt.Color.yellow, java.awt.Color.blue );
	    env.init();
