...
public abstract class ControlUnitSupport extends Subject{
	...
	*/
	...
	protected void st_controlUnit_startMission()  throws Exception{
		...
		storeMissionStarted();curstate = "st_controlUnit_sendCommand"; 
		//resetCurVars(); //leave the current values on
		return;
		/* --- TRANSITION TO NEXT STATE --- */
	}
	...
	protected void st_controlUnit_onMission()  throws Exception{
		...
		//[it.unibo.indigo.contact.impl.SignalImpl@32f25aa8 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@2dd4f822 (name: notify) (var: null)] | forwardCommand isSignal=false
		resCheck = checkForMsg(getName(),"forwardCommand",null);
		if(resCheck){
			curstate = "st_controlUnit_sendCommand";
			return;}
		//[it.unibo.indigo.contact.impl.SignalImpl@32f25aa8 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@2dd4f822 (name: notify) (var: null)] | picturePackage isSignal=false
