...
public abstract class DroneSupport extends Subject{
	...
	*/ 
	...
	protected abstract java.lang.String getDatapicturePackage() throws Exception;
	...
	*/
	...
	protected 
	String datapicturePackage = null;
	...
	public  java.lang.String get_datapicturePackage(){ return datapicturePackage; }
	...
	protected void st_Drone_startMission()  throws Exception{
		...
		setSpeed( cmdValue );curRequest.replyToCaller( "OK" ); 
	...
	protected void st_Drone_onMission()  throws Exception{
		...
		datapicturePackage =getDatapicturePackage(  ) ;
		hl_drone_forward_picturePackage_controlUnit(datapicturePackage );
		//[it.unibo.indigo.contact.impl.SignalImpl@32f25aa8 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@2dd4f822 (name: notify) (var: null)] | command isSignal=false
