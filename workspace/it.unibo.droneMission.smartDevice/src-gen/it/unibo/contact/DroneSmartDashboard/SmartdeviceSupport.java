...
public abstract class SmartdeviceSupport extends Subject{
	...
	*/
	...
	protected void st_Smartdevice_waitingForData()  throws Exception{
		...
		//[it.unibo.indigo.contact.impl.SignalImpl@53dd20e0 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@5a997d23 (name: notify) (var: null)] | sensorsData isSignal=true
		resCheckMsg = checkSignal("ANY","sensorsData",false);
		if(resCheckMsg != null){
			curstate = "st_Smartdevice_receivedData";
			return;}
		//[it.unibo.indigo.contact.impl.SignalImpl@53dd20e0 (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@5a997d23 (name: notify) (var: null)] | notify isSignal=true
	...
	protected void st_Smartdevice_endMission()  throws Exception{
		...
		missionFinished();curstate = "st_Smartdevice_init"; 
		//resetCurVars(); //leave the current values on
		return;
		/* --- TRANSITION TO NEXT STATE --- */
	}
