...
public  class  DroneSubsystemObserver extends Subject implements java.util.Observer{
	protected int lastMsgNum = 0; 
    protected String statusStr =  getName() + " | DroneSubsystemObserver" ;
  
	public DroneSubsystemObserver( ) throws Exception{
		super();	
		initGui();
	}
	...
	protected void initGui(){
	    env = new EnvFrame( "DroneSubsystemObserver", this, java.awt.Color.yellow, java.awt.Color.blue );
	    env.init();
