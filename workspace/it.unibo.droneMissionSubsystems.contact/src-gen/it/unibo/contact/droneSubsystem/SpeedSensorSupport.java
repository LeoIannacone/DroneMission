...
public abstract class SpeedSensorSupport extends Sensor{
	private static SpeedSensor obj = null;
	private IMessage resCheckMsg;
	private boolean resCheck;
	/*
	* Factory method: returns a singleton
	*/
	public static SpeedSensor create(String name) throws Exception{
		if( obj == null ) obj = new SpeedSensor(name);
		return obj;
	}
	/* -------------------------------------
	...
	*/
	...
	//Constructor
	public SpeedSensorSupport(String name) throws Exception{
		super(name);
	 	isMultiInput=true;
	...
	*/
	...
	protected void initGui(){
	    ...
	    env.init();
	    env.writeOnStatusBar(getName() + " | SpeedSensorSupport working ... ",14);
	...
	*/ 
 	...
 	/* -------------------------------------
	* COMMUNICATION CORE OPERATIONS for speedSensor
	* --------------------------------------
	*/
 
	
 	/* -------------------------------------
	* CONNECTION OPERATIONS for speedSensor
	* --------------------------------------
	*/
