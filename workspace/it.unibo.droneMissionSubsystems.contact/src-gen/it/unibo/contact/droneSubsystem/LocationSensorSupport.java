...
public abstract class LocationSensorSupport extends Sensor{
	private static LocationSensor obj = null;
	private IMessage resCheckMsg;
	private boolean resCheck;
	/*
	* Factory method: returns a singleton
	*/
	public static LocationSensor create(String name) throws Exception{
		if( obj == null ) obj = new LocationSensor(name);
		return obj;
	}
	/* -------------------------------------
	...
	*/
	...
	//Constructor
	public LocationSensorSupport(String name) throws Exception{
		super(name);
	 	isMultiInput=true;
	...
	*/
	...
	protected void initGui(){
	    ...
	    env.init();
	    env.writeOnStatusBar(getName() + " | LocationSensorSupport working ... ",14);
	...
	*/ 
 	...
 	/* -------------------------------------
	* COMMUNICATION CORE OPERATIONS for locationSensor
	* --------------------------------------
	*/
 
	
 	/* -------------------------------------
	* CONNECTION OPERATIONS for locationSensor
	* --------------------------------------
	*/
