...
public abstract class OdoSensorSupport extends Sensor{
	private static OdoSensor obj = null;
	private IMessage resCheckMsg;
	private boolean resCheck;
	/*
	* Factory method: returns a singleton
	*/
	public static OdoSensor create(String name) throws Exception{
		if( obj == null ) obj = new OdoSensor(name);
		return obj;
	}
	/* -------------------------------------
	...
	*/
	...
	//Constructor
	public OdoSensorSupport(String name) throws Exception{
		super(name);
	 	isMultiInput=true;
	...
	*/
	...
	protected void initGui(){
	    ...
	    env.init();
	    env.writeOnStatusBar(getName() + " | OdoSensorSupport working ... ",14);
	...
	*/ 
 	...
 	/* -------------------------------------
	* COMMUNICATION CORE OPERATIONS for odoSensor
	* --------------------------------------
	*/
 
	
 	/* -------------------------------------
	* CONNECTION OPERATIONS for odoSensor
	* --------------------------------------
	*/
