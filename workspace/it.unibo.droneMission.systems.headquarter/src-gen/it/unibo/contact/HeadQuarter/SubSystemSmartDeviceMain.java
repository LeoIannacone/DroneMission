...
public class SubSystemSmartDeviceMain implements IContactSystem{
	...
	protected void initSupport(){
		MsgUtil.init(view);
		core = ((LindaLike)LindaLike.initSpace(view,"subSystemSmartDevice"));
	}
	protected void initGui(){
	 env = new EnvFrame( "SubSystemSmartDevice", this );
	 env.init();
	 env.writeOnStatusBar( Thread.currentThread() +  " | SubSystemSmartDevice working ...",14);
	...
	System.out.println("SubSystemSmartDevice TERMINATES");
	try {
...
}//SubSystemSmartDeviceSupportMain
