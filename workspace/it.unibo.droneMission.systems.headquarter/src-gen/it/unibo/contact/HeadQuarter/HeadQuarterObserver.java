...
public  class  HeadQuarterObserver extends Subject implements java.util.Observer{
	protected int lastMsgNum = 0; 
    protected String statusStr =  getName() + " | HeadQuarterObserver" ;
  
	public HeadQuarterObserver( ) throws Exception{
		super();	
		initGui();
	}
	...
	protected void initGui(){
	    env = new EnvFrame( "HeadQuarterObserver", this, java.awt.Color.yellow, java.awt.Color.blue );
	    env.init();
