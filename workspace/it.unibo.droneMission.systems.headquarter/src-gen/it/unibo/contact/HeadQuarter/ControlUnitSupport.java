...
public abstract class ControlUnitSupport extends Subject{
	...
	*/
	...
	protected void st_controlUnit_onMission()  throws Exception{
		...
		//[it.unibo.indigo.contact.impl.SignalImpl@7faabc8e (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@2241501d (name: notify) (var: null)] | forwardCommand isSignal=false
		resCheck = checkForMsg(getName(),"forwardCommand",null);
		if(resCheck){
			curstate = "st_controlUnit_sendCommand";
			return;}
		//[it.unibo.indigo.contact.impl.SignalImpl@7faabc8e (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@2241501d (name: notify) (var: null)] | sensorsData isSignal=true
		resCheckMsg = checkSignal("ANY","sensorsData",false);
		if(resCheckMsg != null){
			curstate = "st_controlUnit_receivedSensorsData";
			return;}
		//[it.unibo.indigo.contact.impl.SignalImpl@7faabc8e (name: sensorsData) (var: null), it.unibo.indigo.contact.impl.SignalImpl@2241501d (name: notify) (var: null)] | picturePackage isSignal=false
